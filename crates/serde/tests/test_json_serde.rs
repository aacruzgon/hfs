...
#[test]
fn test_json_deserialize_timing_with_null_primitive_and_extension() {
    let json_input = r#"
    {
      "timingTiming": {
        "event": [
...
#[test]
fn test_json_decimal_out_of_range() {
...
#[test]
fn test_json_serialize_decimal_with_value_absent() {
    let element = DecimalElement::<Extension> {
...
#[test]
fn test_json_serialize_decimal_with_all_fields() {
    // Use the dec! macro
...
#[test]
fn test_json_serialize_decimal_with_no_fields() {
    let element = DecimalElement::<Extension> {
        id: None,
        extension: None,
        value: None,
...
#[test]
fn test_json_deserialize_decimal_from_integer() {
...
#[test]
fn test_json_roundtrip_decimal_serialization() {
    // Test with a bare integer string
    let json_input = "10";
...
#[test]
fn test_json_decimal_with_trailing_zeros() {
...
#[test]
fn test_json_serialize_element_primitive() {
...
#[test]
fn test_json_serialize_element_object() {
    let element = Element::<std::string::String, Extension> {
...
#[test]
fn test_json_deserialize_element_primitive() {
    // String primitive
...
#[test]
fn test_json_deserialize_element_object() {
    // Full object
...
#[test]
fn test_json_helios_fhir_serde_serialize() {
...
#[test]
fn test_json_flatten_serialization() {
...
#[test]
fn test_json_helios_fhir_serde_deserialize() {
    let decimal = Decimal::new(dec!(123.45));
    // Helper to create default extension
    let default_extension = || Extension {
        id: None,
...
#[test]
fn test_json_timing_roundtrip_serialization() {
    let json_input = r#"
    {
      "timingTiming": {
        "event": [
...
#[test]
fn test_json_helios_fhir_serde_deserialize_extension_with_primitive_extension() {
