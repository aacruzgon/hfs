...
pub struct TestPlanSuite {
    ...
    pub description: Option<String>,
    pub mode: Option<Code>,
    pub input: Option<Vec<Base>>,
    pub parameter: Option<Vec<TestPlanParameter>>,
    pub test: Option<Vec<Base>>,
...
pub struct TestPlan {
    ...
    #[fhir_serde(rename = "copyrightLabel")]
    pub copyright_label: Option<String>,
    pub scope: Option<Vec<Base>>,
    pub dependency: Option<Vec<Base>>,
    pub runner: Url,
    pub mode: Option<Vec<Base>>,
    pub parameter: Option<Vec<Base>>,
    pub suite: Option<Vec<Base>>,
}
